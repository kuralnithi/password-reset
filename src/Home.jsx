...
function Home() {
  ...
  const handleRegBtn = async () => {
    ...
    try {
      ...
      const regResponce = await fetch('https://password-reset-326w.onrender.com/api/user/register', {
  ...
  const handleLoginBtn = async () => {
    ...
    const loginRes = await fetch("https://password-reset-326w.onrender.com/api/user/login", {
  ...
  const handleForget = async () => {
    ...
    try {
      ...
      const forgetFetch = await fetch('https://password-reset-326w.onrender.com/api/resetpassword', {
  ...
  const fetchdata = async () => {
    ...
    try {
      ...
      const responce = await fetch("https://password-reset-326w.onrender.com/api/getuser", {
